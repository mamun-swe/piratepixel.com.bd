...
export const NavbarGeneral = (props) => {
  ...
  return (
    <div className="navbar-general bg-white">
            ...
            <div className="d-flex">
              ...
              {props.searchable ? (
                <div className="px-2 px-md-4">
                  <SearchSmall
                    onSearch={(value) =>
                      history.push(`/search?query=${value.query}`)
                    }
                  />
                </div>
              ) : (
                ...
                <div className="d-flex">
                  <div>
                    ...
                    >
                      ...
                      <Dropdown.Item as={Link} to="/account/upload">
                        Upload
                      </Dropdown.Item>
      ...
      {/* Mobile drawer */}
      <CustomDrawer show={show} data={data} onHide={() => setShow(false)} />
    </div>
  );
};
