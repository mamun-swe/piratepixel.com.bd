  ...
  return (
    <div>
      <Select
        ...
        styles={
          props.error
            ? errorStyle(props.borderRadius)
            : customStyles(props.borderRadius)
        }
  ...
  return (
    <div>
      <Creatable
        ...
        onChange={handleSelect}
        defaultValue={
          props.deafult ? props.deafult.map((item) => ({ ...item })) : null
        }
      />
    </div>
  );
...
export const SearchableSelect = (props) => {
  ...
  const Imageoption = (props) => {
    ...
    return (
      <Option {...props}>
        {props.data.image ? (
          <img src={props.data.image} style={styles.img} alt="..." />
        ) : null}
        {props.data.name}
      </Option>
    );
