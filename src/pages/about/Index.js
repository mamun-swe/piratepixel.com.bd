          ...
          <Container.Column className="col-lg-9 m-auto">
            ...
            <p className="font-15 mb-3">
              ...
              <a
                ...
                href="mailto:info@piratepixel.com"
              >
                info@piratepixel.com
              </a>
            </p>
            <p className="font-15 mb-0">
              <span className="text-primary">PiratePixel</span> Lorem ipsum
            ...
            {members &&
              members.map((item, i) => (
                <div
                  className="d-md-flex text-center text-md-start py-30"
                  key={i}
                >
                  <div>
                  ...
                  <div className="flex-grow-1 ps-md-5 pt-4 pt-md-2 py-2">
                    <h6 className="text-capitalize fw-bolder font-15 mb-3">
