...
const Index = () => {
  const faqs = [
    ...
    {
      title:
        "May PiratePixel images be used on Facebook and other social platforms?",
    },
              ...
              {faqs &&
                faqs.map((item, i) => (
                  <Accordion.Item eventKey={i} key={i}>
                    <Accordion.Button className="shadow-none font-14 fw-bolder text-dark bg-none">
                      {item.title}
                    </Accordion.Button>
                    <Accordion.Body>
                      <p className="font-15 lh-lg mb-0">
                        A cookie is a small file containing a string of
                        characters that is sent to your computer when you visit
                        a website. When you visit the website again, the cookie
                        allows that site to recognize your browser. Cookies are
                        used on Pixabay to store visitor preferences and other
                        technical information required for the functionality of
                        the Website. No personal information is stored in these
                        cookies. You can reset your browser to refuse all
