      ...
      <Container.Fluid className="py-4">
        ...
        <Container.Row>
          ...
          <Container.Column className="col-md-10 col-lg-8 col-xxl-5 m-auto text-center pb-4">
            ...
            <p className="mb-0">
              Pirate Pixel is a vibrant community of creatives, sharing
              copyright free images. All contents are released under the Pirate
              Pixel License, which makes them safe to use without asking for
              permission or giving credit to the artist - even for commercial
              purposes.
            </p>
            <Link to="/faq" className="text-primary text-decoration-none">
              Learn more...
            </Link>
          </Container.Column>
        </Container.Row>
